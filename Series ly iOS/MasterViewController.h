...
#define SELECTEDCOLORAPARIENCIARESULTADOSBUSQUEDA [UIColor colorWithRed:(133/255.0) green:(163/255.0) blue:(206/255.0) alpha:1]
#define TEXTUNSELECTEDCOLORAPARIENCIARESULTADOSBUSQUEDA nil
#define TEXTSELECTEDCOLORAPARIENCIARESULTADOSBUSQUEDA nil
#define UNSELECTEDFONTAPARIENCIARESULTADOSBUSQUEDA nil
#define SELECTEDFONTAPARIENCIARESULTADOSBUSQUEDA nil
#define TEXTALIGNMENTRESULTADOSBUSQUEDA 0
#define ACCESORYTYPERESULTADOSBUSQUEDA UITableViewCellAccessoryDisclosureIndicator
#define LINEBREAKMODERESULTADOSBUSQUEDA 0
#define NUMBEROFLINESRESULTADOSBUSQUEDA 0
#define ACCESORYVIEWRESULTADOSBUSQUEDA nil
//#define CUSTOMHEIGHTCELLRESULTADOSBUSQUEDA 80

#define APARIENCIARESULTADOSBUSQUEDA(BACKGROUNDVIEW,HEIGHTCELL) [[CustomCellAppearance alloc] initWithAppearanceWithCustomBackgroundViewWithSelectedColor:SELECTEDCOLORAPARIENCIARESULTADOSBUSQUEDA unselectedTextColor:TEXTUNSELECTEDCOLORAPARIENCIARESULTADOSBUSQUEDA selectedTextColor:TEXTSELECTEDCOLORAPARIENCIARESULTADOSBUSQUEDA unselectedTextFont:UNSELECTEDFONTAPARIENCIARESULTADOSBUSQUEDA selectedTextFont:SELECTEDFONTAPARIENCIARESULTADOSBUSQUEDA textAlignment:TEXTALIGNMENTRESULTADOSBUSQUEDA accesoryType:ACCESORYTYPERESULTADOSBUSQUEDA lineBreakMode:LINEBREAKMODERESULTADOSBUSQUEDA numberOfLines:NUMBEROFLINESRESULTADOSBUSQUEDA accesoryView:ACCESORYVIEWRESULTADOSBUSQUEDA backgroundView:BACKGROUNDVIEW heightCell:HEIGHTCELL]