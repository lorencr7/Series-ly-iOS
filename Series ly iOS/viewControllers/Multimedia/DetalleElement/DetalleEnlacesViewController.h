//
//  DetalleEnlacesViewController.h
//  Series ly iOS
//
...
#define LABELTEXTCOLORLISTADOCAPITULOSTITULO [UIColor blackColor]
#define LABELTEXTLISTADOCAPITULOSTITULO(texto) texto
#define LABELTEXTFONTLISTADOCAPITULOSTITULO [UIFont boldSystemFontOfSize:17.0]
