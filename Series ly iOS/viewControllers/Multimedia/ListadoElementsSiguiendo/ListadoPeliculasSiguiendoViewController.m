//
//  ListadoPeliculasSiguiendoViewController.m
//  Series ly iOS
//
...
@interface ListadoPeliculasSiguiendoViewController ()

@end

@implementation ListadoPeliculasSiguiendoViewController
...
-(NSMutableArray *) getSourceData {
    ...
    return usuario.peliculasFollowing;
}
